...
exports.WasmCreateSlateResult = WasmCreateSlateResult;

class WasmFinalizedTx {
    static __wrap(ptr) {
...
exports.WasmFinalizedTx = WasmFinalizedTx;

class WasmKeystoreAndMnemonic {
    static __wrap(ptr) {
...
exports.WasmKeystoreAndMnemonic = WasmKeystoreAndMnemonic;

class WasmMerkleProofResult {
    static __wrap(ptr) {
...
exports.WasmMerkleProofResult = WasmMerkleProofResult;

class WasmMintAssetResult {
    static __wrap(ptr) {
...
exports.WasmMintAssetResult = WasmMintAssetResult;

class WasmOwnedOutput {
    static __wrap(ptr) {
...
exports.WasmOwnedOutput = WasmOwnedOutput;

class WasmRecoveryResult {
    static __wrap(ptr) {
...
exports.WasmRecoveryResult = WasmRecoveryResult;

class WasmRegisterNameResult {
    static __wrap(ptr) {
...
exports.WasmRegisterNameResult = WasmRegisterNameResult;

class WasmRespondResult {
    static __wrap(ptr) {
...
exports.WasmRespondResult = WasmRespondResult;

class WasmRotateSeedResult {
    static __wrap(ptr) {
...
exports.WasmRotateSeedResult = WasmRotateSeedResult;
...
exports.WasmSendPlan = WasmSendPlan;

class WasmSlateReservation {
    static __wrap(ptr) {
...
exports.WasmSlateReservation = WasmSlateReservation;

class WasmSweepResult {
    static __wrap(ptr) {
...
exports.WasmSweepResult = WasmSweepResult;
 ...
 * @returns {string}
 */
function attach_creator_signature_to_mint(op_json, creator_signature_hex) {
    let deferred4_0;
    let deferred4_1;
    try {
...
exports.attach_creator_signature_to_mint = attach_creator_signature_to_mint;
 ...
 * @returns {string}
 */
function build_cancel_listing_request(keystore_bytes, asset_id) {
    let deferred4_0;
    let deferred4_1;
    try {
...
exports.build_cancel_listing_request = build_cancel_listing_request;
 ...
 */
function build_collection_mint_asset_request(keystore_bytes, store_bytes, asset_id, metadata, fee, collection_id, phase_index, allowlist_proof_hex, allowlist_leaf_index, required_kernel_excess_hex) {
    const ptr0 = passArray8ToWasm0(keystore_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.build_collection_mint_asset_request = build_collection_mint_asset_request;
 ...
 * @returns {string}
 */
function build_create_listing_request(keystore_bytes, asset_id, price, listed_at) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passArray8ToWasm0(keystore_bytes, wasm.__wbindgen_malloc);
...
exports.build_create_listing_request = build_create_listing_request;
 ...
 * @returns {string}
 */
function build_launch_collection_request(keystore_bytes, collection_id, name, symbol, metadata, phases_json, royalty_bps) {
    let deferred8_0;
    let deferred8_1;
    try {
        const ptr0 = passArray8ToWasm0(keystore_bytes, wasm.__wbindgen_malloc);
...
exports.build_launch_collection_request = build_launch_collection_request;
 ...
 * @returns {WasmMintAssetResult}
 */
function build_mint_asset_request(keystore_bytes, store_bytes, asset_id, metadata, fee) {
    const ptr0 = passArray8ToWasm0(keystore_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(store_bytes, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
...
exports.build_mint_asset_request = build_mint_asset_request;
 ...
 */
function build_register_name_request(keystore_bytes, store_bytes, name, fee) {
    const ptr0 = passArray8ToWasm0(keystore_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(store_bytes, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
...
exports.build_register_name_request = build_register_name_request;
 ...
 * @returns {string}
 */
function build_sponsored_register_name_request(keystore_bytes, name) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passArray8ToWasm0(keystore_bytes, wasm.__wbindgen_malloc);
...
exports.build_sponsored_register_name_request = build_sponsored_register_name_request;
 ...
 * @returns {string}
 */
function build_stake_request(keystore_bytes, store_bytes, min_value) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passArray8ToWasm0(keystore_bytes, wasm.__wbindgen_malloc);
...
exports.build_stake_request = build_stake_request;
 ...
 * @returns {string}
 */
function build_transfer_asset_request(keystore_bytes, asset_id, new_owner_pubkey_hex, required_kernel_excess_hex, required_royalty_kernel_excess_hex) {
    let deferred7_0;
    let deferred7_1;
    try {
        const ptr0 = passArray8ToWasm0(keystore_bytes, wasm.__wbindgen_malloc);
...
exports.build_transfer_asset_request = build_transfer_asset_request;
 ...
 * @returns {string}
 */
function build_transfer_name_request(keystore_bytes, name, new_owner_pubkey_hex, new_resolves_to_hex) {
    let deferred6_0;
    let deferred6_1;
    try {
        const ptr0 = passArray8ToWasm0(keystore_bytes, wasm.__wbindgen_malloc);
...
exports.build_transfer_name_request = build_transfer_name_request;
 ...
 * @returns {Uint8Array}
 */
function claim_genesis(store_bytes) {
...
exports.claim_genesis = claim_genesis;
 ...
 * @returns {Uint8Array}
 */
function commit_mint_asset(store_bytes, spent_commitments_hex, change) {
    const ptr0 = passArray8ToWasm0(store_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.commit_mint_asset = commit_mint_asset;
 ...
 * @returns {Uint8Array}
 */
function commit_receive(store_bytes, output) {
    const ptr0 = passArray8ToWasm0(store_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.commit_receive = commit_receive;
 ...
 * @returns {Uint8Array}
 */
function commit_register_name(store_bytes, spent_commitments_hex, change) {
    const ptr0 = passArray8ToWasm0(store_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArrayJsValueToWasm0(spent_commitments_hex, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
...
exports.commit_register_name = commit_register_name;
 ...
 * @returns {Uint8Array}
 */
function commit_send(store_bytes, spent_commitments_hex, dest, change) {
    const ptr0 = passArray8ToWasm0(store_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArrayJsValueToWasm0(spent_commitments_hex, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
...
exports.commit_send = commit_send;
 ...
 * @returns {Uint8Array}
 */
function commit_slate_send(store_bytes, spent_commitments_hex, change) {
    const ptr0 = passArray8ToWasm0(store_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArrayJsValueToWasm0(spent_commitments_hex, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
...
exports.commit_slate_send = commit_slate_send;
 ...
 */
function compute_allowlist_merkle_proof(pubkeys_hex, target_pubkey_hex) {
...
exports.compute_allowlist_merkle_proof = compute_allowlist_merkle_proof;
 ...
 */
function create_send_slate(keystore_bytes, store_bytes, amount, fee) {
    const ptr0 = passArray8ToWasm0(keystore_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(store_bytes, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
...
exports.create_send_slate = create_send_slate;
 ...
 */
function finalize_slate(pending_slate_bytes, response_slate_json) {
...
exports.finalize_slate = finalize_slate;
...
exports.generate_keystore = generate_keystore;
 ...
 */
function generate_keystore_with_mnemonic() {
    const ret = wasm.generate_keystore_with_mnemonic();
    return WasmKeystoreAndMnemonic.__wrap(ret);
}
exports.generate_keystore_with_mnemonic = generate_keystore_with_mnemonic;
 ...
 */
function pending_slate_reservation(pending_slate_bytes) {
    const ptr0 = passArray8ToWasm0(pending_slate_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.pending_slate_reservation = pending_slate_reservation;
 ...
 */
function plan_send(keystore_bytes, store_bytes, amount, fee) {
    const ptr0 = passArray8ToWasm0(keystore_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(store_bytes, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
function reconcile_wallet_store(store_bytes, chain_utxo_commitments_hex) {
    const ptr0 = passArray8ToWasm0(store_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.reconcile_wallet_store = reconcile_wallet_store;
 ...
 */
function recover_wallet_from_chain(keystore_bytes, scan_entries_json, chain_utxo_commitments_hex) {
    const ptr0 = passArray8ToWasm0(keystore_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.recover_wallet_from_chain = recover_wallet_from_chain;
 ...
 */
function respond_to_slate(keystore_bytes, slate_json) {
    const ptr0 = passArray8ToWasm0(keystore_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.respond_to_slate = respond_to_slate;
 ...
 * @returns {Uint8Array}
 */
function restore_keystore_from_mnemonic(phrase) {
...
exports.restore_keystore_from_mnemonic = restore_keystore_from_mnemonic;
 ...
 * @returns {string}
 */
function reveal_stake_blinding_hex(keystore_bytes, store_bytes, min_value) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passArray8ToWasm0(keystore_bytes, wasm.__wbindgen_malloc);
...
exports.reveal_stake_blinding_hex = reveal_stake_blinding_hex;
 ...
 */
function rotate_seed_transaction(old_keystore_bytes, store_bytes, new_keystore_bytes, fee) {
...
exports.rotate_seed_transaction = rotate_seed_transaction;
 ...
 * @returns {string}
 */
function sign_allowlist_publish(keystore_bytes, collection_id, phase_index, pubkeys_hex, published_at) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passArray8ToWasm0(keystore_bytes, wasm.__wbindgen_malloc);
...
exports.sign_allowlist_publish = sign_allowlist_publish;
 ...
 * @returns {string}
 */
function sign_collection_mint_approval(keystore_bytes, asset_id, collection_id, phase_index, required_kernel_excess_hex, owner_pubkey_hex) {
    let deferred7_0;
    let deferred7_1;
    try {
        const ptr0 = passArray8ToWasm0(keystore_bytes, wasm.__wbindgen_malloc);
...
exports.sign_collection_mint_approval = sign_collection_mint_approval;
 ...
 * @returns {string}
 */
function sign_identity_message(keystore_bytes, message) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passArray8ToWasm0(keystore_bytes, wasm.__wbindgen_malloc);
...
exports.sign_identity_message = sign_identity_message;
 ...
 */
function sweep_validator_rewards(stake_key_hex, scan_entries_json, chain_utxo_commitments_hex, keystore_bytes, fee) {
...
exports.sweep_validator_rewards = sweep_validator_rewards;
 ...
 * @returns {string}
 */
function tx_kernel_excess_hex(transaction_json) {
    let deferred3_0;
    let deferred3_1;
    try {
...
exports.tx_kernel_excess_hex = tx_kernel_excess_hex;
 ...
 * @returns {boolean}
 */
function verify_identity_signature(pubkey_hex, message, signature_hex) {
...
exports.verify_identity_signature = verify_identity_signature;
 ...
 * @returns {bigint}
 */
function wallet_balance(store_bytes) {
    const ptr0 = passArray8ToWasm0(store_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.wallet_balance = wallet_balance;
 ...
 * @returns {string}
 */
function wallet_identity_pubkey_hex(keystore_bytes) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray8ToWasm0(keystore_bytes, wasm.__wbindgen_malloc);
...
exports.wallet_identity_pubkey_hex = wallet_identity_pubkey_hex;
 ...
 * @returns {bigint}
 */
function wallet_pending_balance(store_bytes) {
    const ptr0 = passArray8ToWasm0(store_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.wallet_pending_balance = wallet_pending_balance;

/**
 * Creates an empty wallet store and returns its serialized bytes.
 * @returns {Uint8Array}
 */
function wallet_store_new() {
    const ret = wasm.wallet_store_new();
    var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    return v1;
}
exports.wallet_store_new = wallet_store_new;
...
const wasmPath = `${__dirname}/haze_core_bg.wasm`;
