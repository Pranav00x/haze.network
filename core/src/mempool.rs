...
impl Mempool {
    ...
    pub fn clear_stale_name_ops(&mut self, registered_names: &[String], spent_commitments: &[haze_crypto::pedersen::Commitment]) {
        use std::collections::HashSet;
    ...
    pub fn clear_stale_mint_ops(&mut self, minted_assets: &[String], spent_commitments: &[haze_crypto::pedersen::Commitment]) {
        use std::collections::HashSet;
...
mod tests {
    use super::*;
    use crate::transaction::{Input, Output, TxKernel};
    use haze_crypto::pedersen::Commitment;
    ...
    fn make_valid_name_op_with_fee(name: &str, fee: u64) -> RegisterNameOp {
        use crate::registry::RegisterNameOp;
    ...
    fn add_transfer_asset_op_accepts_conditional_transfer_optimistically() {
        use crate::assets::TransferAssetOp;
        use bulletproofs::PedersenGens;
    ...
    fn add_transfer_op_rejects_once_pending_queue_is_full() {
        use crate::registry::TransferNameOp;
        use bulletproofs::PedersenGens;
